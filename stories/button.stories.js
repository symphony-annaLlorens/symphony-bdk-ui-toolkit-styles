...
<div class="tk-m-2">
  ...
  <button class="tk-button tk-button--primary tk-button--medium" disabled>Disabled <i class="tk-icon-lock"></i></button>
</div>
<div class="tk-m-2">
...
<div class="tk-my-1h">Adding the <span class="code">.condensed</span> or <span class="code">.tk-theme-condensed</span>class on a parent element of the button component will
...
<div id="scape-area" class="tk-escape-condensed">
  <span class="tk-switch tk-m-3">
    ...
    <label class="tk-switch__label" for="switch" id="scape">Escape condensed</label>
  </span>
